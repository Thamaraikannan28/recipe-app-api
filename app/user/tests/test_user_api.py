...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email': '12345@gmail.com', 'password': 'pw'}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_invalid_credentials(self):
        """Test that token is not created if details mismatch"""
        create_user(email="test@gmail.com", password="password")
        payload = {'email': 'test@gmail.com', 'password': 'passsword'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_no_user(self):
        """Test that token is not created if token doesn't exist"""
        payload = {'email': 'test@gmail.com', 'password': 'passsword'}
        res = self.client.post(TOKEN_URL, payload)
